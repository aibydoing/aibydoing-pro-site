...
const faqs = [
  [
    ...
    },
    {
      ...
      answer:
        '额，我不建议这么做，这会损害我的利益，但我也无法阻止你。我期望你尊重知识产权，不进行二次分发和传播。如果你有朋友想要学习，请推荐他们购买。',
    },
  ],
  [
    {
  ...
  [
    {
      ...
      answer:
        '目前没有设定时间和次数限制，但请尊重我的时间。我有家庭、有工作、有爱好。我会尽量帮助你学习，但是不会像老师一样全天在线解答问题，也不会做到有问必答。对于很多基础的问题，我可能会给到你解决问题的方法，而不是直接给出答案。学习是你自己的事情，我只是一个引导者，无法对你的学习结果负责。当然，不用担心我是一个傲慢且不好沟通的人，我们应该会相处愉快。',
    },
    {
      question: '我可以使用哪些支付方式？',
      answer:
        '中国大陆地区可以使用支付宝或微信，其他地区可以使用 Paypal 给作者付款。',
    },
  ],
]
