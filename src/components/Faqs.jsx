  ...
  [
    {
      ...
      answer:
        'Jupyter Notebook 是 Python 机器学习领域最流行的交互式编程环境。本课程内容的原始载体是 Jupyter Notebook 文档，你可以通过打开作者编写好的 Jupyter Notebook 文档边学边练。',
    },
    {
    ...
    },
    {
      ...
      answer:
        '额，我不希望你这么做，但我无法阻止你。请尊重知识产权，不进行二次分发和传播。如果你有朋友想要学习，请推荐他们付费支持。',
    },
  ],
  [
    {
      ...
      answer:
        '不可以。如果你有商业用途的需求，请联系作者购买商业授权。目前仅供购买者个人学习用途。',
    },
    {
  ...
  [
    {
      ...
      answer:
        '目前没有设定时间和次数限制，但请尊重我的时间。我有家庭、有工作、有爱好。我会尽量帮助你学习，但不会像老师一样全天在线解答问题。我可以做到你的每一条留言都会得到回复。对于很多基础的问题，我可能会给到你解决问题的方法，而不是直接给出答案。学习是你自己的事情，我只是一个引导者。',
    },
    {
